var data = {
    ...
    },
    {
      ...
      description: "This project will show the top 5 images. These images are nothing but the drawing done by kids using MSPaint.:)",
    ...
    },
    {
      name: "Video Player",
      alias: "video-player",
      image: "/projects/video-player/images/video-player.png",
      description: "This project will show the top 5 videos. These videos are nothing but the drawing done by kids using MSPaint.:)",
      githubUrl: "https://www.github.com/mnegi/video-player",
      tags: [{name:"JavaScript",class:"primary"},{name:"Canvas",class:"secondary"},{name:"String",class:"info"}],
      imageSliders: ['slide1.png','slide2.png','slide3.png'],
      relatedProjects: [{name:'JS Console', link: 'js-console'},{name:'Image Gallery', link: 'image-gallery'}, {name:'Bouncing Balls', link: 'bouncing-balls'}, {name:'Matrix Effect', link: 'matrix-effect'}]
    }
